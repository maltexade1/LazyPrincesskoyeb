...
Type And Send The Title Of The Movie You Want And I Will Send It To You. Movies Only Please. 

I Cᴀɴ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇs Fᴏʀ Yᴏᴜ Jᴜsᴛ Aᴅᴅ Mᴇ Iɴ Yᴏᴜʀ Gʀᴏᴜᴘ </b>"""
    LZTHMB_TEXT = """Hello {},
...
"""
    ABOUT_TXT = """✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/maltexade>Maltexade</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙷𝙴𝚁𝙾𝙺𝚄/Koyeb
✯ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂: v10.0.0 [ 𝙱𝙴𝚃𝙰 ]"""

    SOURCE_TXT = """<b>NOTE:</b>
- Agegewa is a telegram movie search engine. 
- It's created by Maltexade.  
- Please share my link with your friends http://t.me/agegewabot
<b>Creator:</b>
- 🦋 <a href=https://t.me/maltexade>Maltexade</a> 🦋"""
...
2. Agege Wa supports buttons with any telegram media type.
3. Buttons should be properly parsed as markdown format

<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/plus234entertainments)</code>
...
<b>NOTE:</b>
these are the extra features of Agege Wa
...
<b>NOTE:</b>
This Module Only Works For My Creator
